...
// 8-bit linear to 16-bit sRGB LUT (open to improvement)
var l8s16 = [...]uint16{
	0x0000, 0x0cfb, 0x15f9, 0x1c71, 0x21cf, 0x2673, 0x2a94, 0x2e54,
	0x31c7, 0x34fc, 0x37fe, 0x3ad3, 0x3d84, 0x4013, 0x4287, 0x44e0,
	0x4723, 0x4950, 0x4b6c, 0x4d75, 0x4f70, 0x515b, 0x5339, 0x550a,
	0x56d1, 0x588b, 0x5a3d, 0x5be3, 0x5d82, 0x5f17, 0x60a5, 0x622b,
	0x63a9, 0x6521, 0x6692, 0x67fd, 0x6962, 0x6ac1, 0x6c1a, 0x6d6f,
	0x6ebe, 0x7008, 0x714f, 0x728f, 0x73cd, 0x7505, 0x763a, 0x776b,
	0x7898, 0x79c2, 0x7ae7, 0x7c0a, 0x7d29, 0x7e45, 0x7f5e, 0x8074,
	0x8187, 0x8297, 0x83a4, 0x84af, 0x85b7, 0x86bd, 0x87bf, 0x88c0,
	0x89bf, 0x8aba, 0x8bb4, 0x8cab, 0x8da1, 0x8e94, 0x8f85, 0x9074,
	0x9161, 0x924d, 0x9336, 0x941e, 0x9504, 0x95e7, 0x96ca, 0x97ab,
	0x9889, 0x9967, 0x9a42, 0x9b1d, 0x9bf5, 0x9ccd, 0x9da2, 0x9e77,
	0x9f49, 0xa01b, 0xa0eb, 0xa1ba, 0xa287, 0xa353, 0xa41e, 0xa4e7,
	0xa5b0, 0xa677, 0xa73d, 0xa802, 0xa8c5, 0xa988, 0xaa49, 0xab09,
	0xabc9, 0xac86, 0xad44, 0xae00, 0xaebb, 0xaf75, 0xb02d, 0xb0e6,
	0xb19d, 0xb253, 0xb308, 0xb3bc, 0xb46f, 0xb522, 0xb5d3, 0xb684,
	0xb734, 0xb7e3, 0xb891, 0xb93e, 0xb9eb, 0xba96, 0xbb41, 0xbbeb,
	0xbc94, 0xbd3d, 0xbde5, 0xbe8b, 0xbf32, 0xbfd7, 0xc07c, 0xc120,
	0xc1c3, 0xc266, 0xc308, 0xc3aa, 0xc44a, 0xc4ea, 0xc589, 0xc628,
	0xc6c6, 0xc763, 0xc800, 0xc89c, 0xc938, 0xc9d2, 0xca6d, 0xcb07,
	0xcb9f, 0xcc38, 0xccd0, 0xcd67, 0xcdfe, 0xce94, 0xcf2a, 0xcfbf,
	0xd054, 0xd0e7, 0xd17b, 0xd20e, 0xd2a0, 0xd332, 0xd3c4, 0xd454,
	0xd4e5, 0xd574, 0xd604, 0xd693, 0xd721, 0xd7af, 0xd83d, 0xd8c9,
	0xd956, 0xd9e2, 0xda6d, 0xdaf9, 0xdb83, 0xdc0d, 0xdc97, 0xdd21,
	0xdda9, 0xde32, 0xdeba, 0xdf41, 0xdfc9, 0xe04f, 0xe0d6, 0xe15c,
	0xe1e1, 0xe266, 0xe2eb, 0xe36f, 0xe3f3, 0xe477, 0xe4fa, 0xe57d,
	0xe5ff, 0xe681, 0xe702, 0xe784, 0xe804, 0xe885, 0xe905, 0xe985,
	0xea05, 0xea83, 0xeb02, 0xeb80, 0xebfe, 0xec7c, 0xecfa, 0xed76,
	0xedf3, 0xee6f, 0xeeeb, 0xef67, 0xefe2, 0xf05d, 0xf0d8, 0xf152,
	0xf1cc, 0xf246, 0xf2bf, 0xf338, 0xf3b1, 0xf429, 0xf4a2, 0xf519,
	0xf591, 0xf608, 0xf67f, 0xf6f6, 0xf76c, 0xf7e2, 0xf858, 0xf8cd,
	0xf943, 0xf9b7, 0xfa2c, 0xfaa1, 0xfb14, 0xfb88, 0xfbfc, 0xfc6f,
	0xfce2, 0xfd55, 0xfdc7, 0xfe39, 0xfeab, 0xff1d, 0xff8e, 0xffff,
}
...
func SRGB16ToLinear(srgb uint16) uint16 {
	...
	si := s0 + div257(mod*(s1-s0)+78) // magic bias
	return uint16(si)
}
...
func LinearToSRGB8(lin uint16) uint8 {
	...
	return uint8(div257(srgb + 128)) // correct bias
}

// Fast 16-bit linear to 8-bit sRGB conversion.
// Returns the correctly rounded result for 74.3% of inputs,
...
func LinearToSRGB16(lin uint16) uint16 {
	...
	li := l0 + div257(mod*(l1-l0)+128) // correct bias
	return uint16(li)
}

// valid for [0..16777215]
func div257(x int) int {
	mul := uint64(x) * 16711936
	div := mul >> 32
	return int(div)
}
